...
int main()
{
    ...
    /* soru :
    ** int tipinde a ve b dizisinin eleman sayisini kullanicidan isteyen daha sonra
    kullanicidan elemanlari girmesini isteyen programi yazin
    ** a dizisini ekrana basin
    ** b dizisini ekrana basin
